...
function updateProject(project, projects) {
  ...
  newProject.textContent =
    project.getName() + " (" + project.getTasks().length + ")";
...
function update(indexOfProject, project) {
  ...
  projects.children[indexOfProject].textContent =
    project.getName() + " (" + project.getTasks().length + ") ";
}
...
export {
  ...
  appendNewTasksToProject,
  deleteTask,
  projectDeletionDisplay,
};
